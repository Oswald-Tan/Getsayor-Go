                    ...
                    : () async {
                        ...
                        try {
                          ...
                          List<Map<String, dynamic>> items =
                              cartItems.map((item) {
                            int totalHarga =
                                item.product.hargaRp * item.quantity;

                            //hitung berat
                            int berat = item.quantity * item.product.jumlah;
                            print("Jumlah: ${item.product.jumlah}");
                              ...
                              PageRouteBuilder(
                                pageBuilder:
                                  ...
                                  namaProduk:
                                    ...
                                    return '${item.product.nameProduk} (${item.product.jumlah} ${item.product.satuan == "Gram" ? "gr" : item.product.satuan == "Kilogram" ? "kg" : item.product.satuan == "Biji" ? "biji" : item.product.satuan})';
                                  }).toList(),
                                  jumlah: widget.quantities, // Kirim quantities
                                  berat: widget.selectedProducts
                                      .map((item) =>
                                          item.quantity * item.product.jumlah)
                                      .toList(),
                    ...
                    : () async {
                        ...
                        try {
                          ...
                          List<Map<String, dynamic>> items =
                              cartItems.map((item) {
                            int totalHarga =
                                item.product.hargaPoin * item.quantity;
                            ...
                            Navigator.of(context, rootNavigator: true).push(
                              PageRouteBuilder(
                                pageBuilder:
                                  ...
                                  namaProduk:
                                      widget.selectedProducts.map((item) {
                                    return '${item.product.nameProduk} (${item.product.jumlah} ${item.product.satuan == "Kilogram" ? "kg" : item.product.satuan == "Gram" ? "gr" : item.product.satuan == "Biji" ? "biji" : item.product.satuan})';
                                  }).toList(),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    '${item.product.nameProduk} (${item.product.jumlah} ${item.product.satuan == 'Gram' ? 'gr' : item.product.satuan == 'Kilogram' ? 'kg' : item.product.satuan == 'Biji' ? 'biji' : item.product.satuan})',
                                    style: const TextStyle(
                                      fontFamily: 'Poppins',
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600,
