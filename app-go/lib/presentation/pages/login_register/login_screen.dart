  ...
  void login() async {
    ...
    try {
      ...
      if (errorString.contains('Connection timeout')) {
        ...
        message =
            'Email yang Anda masukkan tidak terdaftar. Silakan periksa kembali atau daftar akun baru.';
        imagePath = 'assets/images/no-internet.png';
      } else if (errorString.contains('Invalid password')) {
        title = 'Password Salah';
        message =
            'Password yang Anda masukkan tidak sesuai. Silakan periksa kembali password Anda.';
        imagePath = 'assets/images/no-internet.png';
      } else if (errorString.contains('not approved')) {
        title = 'Akun Belum Disetujui';
        message =
            'Akun Anda belum disetujui oleh admin. Silakan hubungi support untuk informasi lebih lanjut.';
        imagePath = 'assets/images/no-internet.png';
      } else if (errorString.contains('credentials') ||
          errorString.contains('Unauthorized')) {
        title = 'Login Gagal';
        message =
            'Email atau password yang Anda masukkan salah. Silakan periksa kembali credentials Anda.';
        imagePath = 'assets/images/no-internet.png';
      } else {
        title = 'Server Error';
        message =
