...
class OrderPageState extends State<OrderPage> {
  ...
  Widget _buildTimeFilterDropdown() {
    return Container(
      margin: const EdgeInsets.only(left: 16, top: 0, right: 16, bottom: 8),
      child: Row(
        children: [
          // Time filter chips
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  _buildTimeFilterChip('Hari Ini', 'today', Icons.today),
                  const SizedBox(width: 8),
                  _buildTimeFilterChip('Minggu', 'week', Icons.view_week),
                  const SizedBox(width: 8),
                  _buildTimeFilterChip('Bulan', 'month', Icons.calendar_month),
                  const SizedBox(width: 8),
                  _buildTimeFilterChip('Tahun', 'year', Icons.date_range),
                ],
              ),
            ),
          ),
  ...
  Widget _buildTimeFilterChip(String text, String value, IconData icon) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(25),
          border: Border.all(
            color: isSelected ? filter['color'] : const Color(0xFFE8E8E8),
            width: 1.5,
          ),
        ),
        child: Row(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      // Tampilkan icon poin hanya jika metode pembayaran Poin
                      if (pesanan.metodePembayaran == 'Poin')
                        Padding(
