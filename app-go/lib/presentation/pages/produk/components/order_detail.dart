...
class OrderDetailPage extends StatelessWidget {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => OrderConfirmationPage(
            ...
            satuan: item.satuan,
            hargaProduk: pesanan.metodePembayaran == 'Poin'
                ? item.harga.toString()
                : formatRupiah(item.harga),
            ongkir: pesanan.metodePembayaran == 'Poin'
                ? shippingCost.toString()
                : formatRupiah(shippingCost),
            totalBayar: pesanan.metodePembayaran == 'Poin'
                ? (item.harga * item.jumlah).toString()
                : formatRupiah(item.harga * item.jumlah),
            totalBayarSemua: pesanan.metodePembayaran == 'Poin'
        ...
        MaterialPageRoute(
          builder: (context) => OrderConfirmationCartPage(
            ...
            hargaProduk: pesanan.items
                .map((e) => pesanan.metodePembayaran == 'Poin'
                    ? e.harga.toString()
            ...
            ongkir: pesanan.metodePembayaran == 'Poin'
                ? shippingCost.toString()
                : formatRupiah(shippingCost),
            totalHarga: pesanan.metodePembayaran == 'Poin'
  ...
  String formatFullTanggal(String isoDate) {
  ...
  Widget _buildStatusTimeline() {
    return Column(
      ...
      children: [
        ...
        _buildTimelineItem(
          status: OrderPageState.statusMap[pesanan.status] ?? pesanan.status,
          date: formatFullTanggal(pesanan.updatedAt),
          isActive: true,
          isLast: pesanan.status == 'pending',
        ),
        if (pesanan.status != 'pending')
          _buildTimelineItem(
            status: 'Pesanan Dibuat',
            date: formatFullTanggal(pesanan.createdAt),
            isActive: false,
            isLast: true,
          ),
      ],
          ...
          Column(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color: isActive ? const Color(0xFF74B11A) : Colors.white,
                  border: Border.all(
                    color: isActive
              ...
              if (!isLast)
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isActive
                        ? const Color(0xFF74B11A).withOpacity(0.3)
                        : const Color(0xFFE5E7EB),
                    ...
                    children: [
                      ...
                      if (isActive) ...[
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: const Color(0xFF74B11A).withOpacity(0.15),
                            borderRadius: BorderRadius.circular(12),
                          ),
                          child: const Text(
                            'Terbaru',
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildInfoRow(
                      ...
                      label: 'Dibuat',
                      value: formatFullTanggal(pesanan.createdAt),
                    ),

                    const SizedBox(height: 16),

                    // TAMBAHKAN TANGGAL UPDATE TERAKHIR
                    _buildInfoRow(
                      icon: Icons.update_outlined,
                      label: 'Terakhir Diperbarui',
                      value: formatFullTanggal(pesanan.updatedAt),
                    ),
                  ],
                ),
              ),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            if (pesanan.metodePembayaran == 'Poin')
                              Padding(
