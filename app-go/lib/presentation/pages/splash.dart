...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Future<void> _navigateToNextScreen() async {
    ...
    final bool? firstRunPref = prefs.getBool('first_run');
    final bool firstRun = firstRunPref ?? true;

    print('First run value: $firstRun');

    // Prioritaskan pengecekan onboarding terlebih dahulu
    if (firstRun) {
      if (mounted) {
        Navigator.pushReplacementNamed(context, OnboardingScreen.routeName);
      }
      return; // Penting: keluar dari fungsi setelah navigasi
    }
