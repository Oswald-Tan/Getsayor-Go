...
class AuthProvider with ChangeNotifier {
  ...
  Future<String?> registerUser({
    ...
    final url = Uri.parse('$baseUrl/auth-app/register');
  ...
  Future<void> logout() async {
    ...
    if (token != null) {
      ...
      final url = Uri.parse('$baseUrl/auth-app/logout');
  ...
  Future<void> initialize() async {
    ...
    // Perbarui FCM token jika user sudah login
    if (_token != null) {
      await _getAndUpdateFcmToken();
    }
