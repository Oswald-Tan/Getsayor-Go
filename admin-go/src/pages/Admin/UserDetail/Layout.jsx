    ...
    <div className="">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          {/* Card Header */}
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 px-4 sm:px-8 py-6">
            <div className="flex flex-col sm:flex-row items-center sm:items-start">
              ...
              <div className="sm:ml-6 text-center sm:text-left min-w-0 flex-1">
                <h2 className="text-xl sm:text-2xl font-bold text-white break-words">
                  {userDetails?.fullname || "User"}
                </h2>
                <p className="text-blue-100 text-sm mt-1 break-all">User ID: {id}</p>
              </div>
            </div>
          </div>
          ...
          <div className="px-4 sm:px-8 py-6 sm:py-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 sm:p-6">
                <div className="flex items-start mb-3">
                  <div className="flex items-center justify-center w-10 h-10 bg-blue-100 dark:bg-blue-800 rounded-lg mr-3 flex-shrink-0">
                    <svg
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 sm:p-6">
                <div className="flex items-start mb-3">
                  <div className="flex items-center justify-center w-10 h-10 bg-green-100 dark:bg-green-800 rounded-lg mr-3 flex-shrink-0">
                    <svg
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 sm:p-6">
                <div className="flex items-start mb-3">
                  <div className="flex items-center justify-center w-10 h-10 bg-purple-100 dark:bg-purple-800 rounded-lg mr-3 flex-shrink-0">
                    <svg
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 sm:p-6">
                <div className="flex items-start mb-3">
                  <div className="flex items-center justify-center w-10 h-10 bg-orange-100 dark:bg-orange-800 rounded-lg mr-3 flex-shrink-0">
                    <svg
            ...
            <div className="mt-6 sm:mt-8 bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 sm:p-6">
              <div className="flex items-center mb-3">
                <div className="flex items-center justify-center w-8 h-8 bg-blue-100 dark:bg-blue-800 rounded-lg mr-3 flex-shrink-0">
                  <svg
